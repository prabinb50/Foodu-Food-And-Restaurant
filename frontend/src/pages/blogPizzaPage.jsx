...
import BlogSectionPizzaLeft from '../components/blogSectionPizzaLeft'
import BlogSectionPizzaRight from '../components/blogSectionPizzaRight'

export default function BlogPizzaPage() {
    return (
            ...
            <div className='mt-25'>
                <div className=' flex flex-col md:flex-row w-10/12 mx-auto justify-between gap-10 '>
                    <div className='md:w-8/12 w-full'>
                        <BlogSectionPizzaLeft></BlogSectionPizzaLeft>
                    </div>

                    <div className='md:w-4/12 w-full'>
                        <BlogSectionPizzaRight></BlogSectionPizzaRight>
                    </div>
                </div>
            </div>
        </div>
