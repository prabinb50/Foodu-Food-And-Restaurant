...
import BlogSectionFoodLeft from '../components/blogSectionFoodLeft'
import BlogSectionFoodRight from '../components/blogSectionFoodRight'

export default function BlogFoodPage() {
    return (
            ...
            <div className='mt-25'>
                <div className=' flex flex-col md:flex-row w-10/12 mx-auto justify-between gap-10 '>
                    <div className='md:w-8/12 w-full'>
                        <BlogSectionFoodLeft></BlogSectionFoodLeft>
                    </div>

                    <div className='md:w-4/12 w-full'>
                        <BlogSectionFoodRight></BlogSectionFoodRight>
                    </div>
                </div>
            </div>
        </div>
