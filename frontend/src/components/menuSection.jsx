    ...
    return (
      <div className="bg-neutral-900 font-serif text-white p-20">
        ...
        <div className="bg-neutral-800 p-10 border rounded-2xl border-none">
          <img src={breakfastImage} className="h-54 border-8 border-neutral-900 rounded-full" alt="breakfast" />
          ...
          <button className="bg-red-500 text-white px-27 py-2 rounded-md mt-4">Make Order</button>
        </div>

        <div className="bg-neutral-800 p-10 border rounded-2xl border-none">
          <img src={lunchImage} className="h-54 border-8 border-neutral-900 rounded-full" alt="lunch" />
        ...
        <div className="bg-neutral-800 p-10 border rounded-2xl border-none">
          <img src={dinnerImage} className="h-54 border-8 border-neutral-900 rounded-full" alt="dinner" />
          ...
          <button className="bg-red-500 text-white px-27 py-2 rounded-md mt-4 cursor-pointer">Make Order</button>
        </div>
      </div>
    </div>
  );
