...
export default function NewsAndBlog() {
    return (
        <div className='p-20'>
            {/* first child */}
            <div className="font-serif flex items-center justify-between flex-col">
                ...
                <span className="text-5xl font-semibold">Our Latest News & Blog</span>
            </div>

            {/* second child */}
            <div className='grid grid-cols-3 cursor-pointer mt-15'>
                {/* second: left child */}
                <div className='relative object-cover space-y-3'>
                    <img src="/burger.jpg" alt="" className='w-85 rounded-md' />
                ...
                {/* second: middle child */}
                <div className='relative object-cover space-y-3'>
                    <img src="/food.jpg" alt="" className='w-85 rounded-md' />
                ...
                {/* second: right child */}
                <div className='relative object-cover space-y-3'>
                    <img src="/pizza.jpg" alt="" className='w-85 rounded-md' />
