                ...
                <div className='flex flex-col space-y-4'>
                    <div className='flex items-start space-x-4'>
                        ...
                        <div className='space-y-2'>
                            ...
                            <p className='font-semibold cursor-pointer hover:text-red-500 hover:underline'>Announcing if attachment resolution sentiments ...</p>
                        </div>
                    </div>

                    <div className='flex items-start space-x-4'>
                        <img src='food.jpg' alt='Post 2' className='w-20 h-16 object-cover rounded-md cursor-pointer' />
                        <div className='space-y-2'>
                            <p className='text-sm opacity-60'>13 August, 2024</p>
                            <p className='font-semibold cursor-pointer hover:text-red-500 hover:underline'>Minuter him own clothes but observe country at ...</p>
                        </div>
                    </div>

                    <div className='flex items-start space-x-4'>
                        <img src='pizza.jpg' alt='Post 3' className='w-20 h-16 object-cover rounded-md cursor-pointer' />
                        <div className='space-y-2'>
                            <p className='text-sm opacity-60'>14 August, 2024</p>
                            <p className='font-semibold cursor-pointer hover:text-red-500 hover:underline'>Minuter him own clothes but observe country mai ...</p>
                        </div>
                    </div>
                </div>
            </div>
