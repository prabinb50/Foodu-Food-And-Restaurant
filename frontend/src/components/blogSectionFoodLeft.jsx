...
export default function BlogSectionFoodLeft() {
    ...
    return (
        <div className=' space-y-7'>
            <img src="/food.jpg" alt="" className='rounded-md w-180 h-90 object-cover' />
            <p className='opacity-70 font-semibold flex cursor-pointer'>13 AUGUST, 2024 <span className='flex hover:text-red-500 hover:opacity-90'><Dot />MD SOHAG</span></p>
