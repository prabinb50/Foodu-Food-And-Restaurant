        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 pt-10 gap-8'>
            {
                items.map((eachItem, index) => (
                    <div key={index} className='flex flex-col lg:flex-row items-center gap-4 lg:gap-8 bg-[#EBE9E6] border-1 border-gray-300  rounded-md p-5 lg:p-10 hover:shadow-lg transition-all duration-300'>
                        {/* item image */}
